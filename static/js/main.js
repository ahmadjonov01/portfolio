...
$(document).ready(function () {
  ...
  $('.reset').click(function () {
    $(this).siblings().removeClass('normal');
    $('body').removeClass(
      'grayscale invert contrast small_size normal_size high_size'
    );
  });
  $('.grayscale').click(function () {
    $(this).siblings().removeClass('grayscale');
    $('body').toggleClass('grayscale');
    $('body').removeClass('invert contrast contrast');
  });
  $('.invert').click(function () {
    $(this).siblings().removeClass('invert');
    $('body').toggleClass('invert');
    $('body').removeClass('grayscale normal contrast');
  });
  $('.contrast').click(function () {
    $(this).siblings().removeClass('contrast');
    $('body').toggleClass('contrast');
    $('body').removeClass('grayscale normal invert');
  });
  $('.small_size').click(function () {
    document.querySelector('*').style.fontSize = '80%';
  });
  $('.normal_size').click(function () {
    document.querySelector('*').style.fontSize = '100%';
  });
  $('.high_size').click(function () {
    document.querySelector('*').style.fontSize = '120%';
  });
  ...
  $('.accessibility').click(function () {
    $('.accessibility_menu').toggleClass('active');
    $('.bg_dark').addClass('active');
    $('.search_input').removeClass('active');
  });
  $('.close_icon').click(function () {
    $('.accessibility_menu').removeClass('active');
  ...
  $('.tabcontent').click(function () {
    $('.opencontent').css('display:none !important;');
  });
  ...
  $.fancyConfirm = function (opts) {
    ...
    $.fancybox.open({
      ...
      src:
        ...
        opts.noButton +
        '</a>' +
        '<button data-value="1" data-fancybox-close class="btn">' +
        opts.okButton +
        '</button>' +
        '</p>' +
        '</div>',
